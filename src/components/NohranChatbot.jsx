...
export default function NohranChatbot({ 
  ...
  const generateBotResponse = (query) => {
    ...
    if (q.includes('67') || q.includes('2567') || (q.includes('ช่วง') && (q.includes('ม.ค') || q.includes('มิ.ย')))) {
      ...
      let responseText = `📅 **รายงานคำสั่งและภาระงานในช่วงปี ๒๕๖๗ (๑ ม.ค. ๖๗ – ๒๕ มิ.ย. ๖๗)**\n\n`;
...
ตามที่ มหาวิทยาลัยราชภัฏนครสวรรค์ ได้มีคำสั่งที่ ${firstOrder?.orderNumber || 'มรภ.นว. ๐๘๙๕/๒๕๖๙'} เรื่อง "${firstOrder?.title || 'แต่งตั้งคณะกรรมการจัดกิจกรรมโครงการบริการวิชาการ'}" นั้น
