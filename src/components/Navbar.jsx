      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 gap-3">
          ...
          <div className="flex items-center gap-2">
            {/* Live OCR Studio External Link */}
            <a
              href="http://localhost:5174"
              target="_blank"
              rel="noopener noreferrer"
              className="hidden lg:flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold bg-sky-50 hover:bg-sky-100 text-sky-700 border border-sky-200 transition-all shadow-2xs"
              title="เปิดศูนย์ทดสอบ Live Thai OCR Studio (Port 5174)"
            >
              <ScanLine className="w-3.5 h-3.5 text-sky-600" />
              <span>Live OCR (5174)</span>
